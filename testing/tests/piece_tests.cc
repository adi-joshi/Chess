...
TEST(PawnTests, PawnInitialization) {
  auto white_pawn = new Pawn(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto black_pawn = new Pawn(nullptr, std::make_shared<Square>(5, 2), Color::Black);
...
TEST(PawnTests, PawnSetters) {
  auto wp_setter = new Pawn(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto bp_setter = new Pawn(nullptr, std::make_shared<Square>(2, 5), Color::Black);
...
TEST(PawnTests, PawnMovementOnEmptyBoard) {
  ...
  auto wpeb1 = new Pawn(b, std::make_shared<Square>(2, 5), Color::White);
  ...
  pieces.clear();
  auto wpeb2 = new Pawn(b, std::make_shared<Square>(7, 5), Color::White);
  ...
  pieces.clear();
  auto bpeb1 = new Pawn(b, std::make_shared<Square>(7,3), Color::Black);
  ...
  pieces.clear();
  auto bpeb2 = new Pawn(b, std::make_shared<Square>(2,3), Color::Black);
...
TEST(PawnTests, PawnMovementCapture) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto wpc1 = new Pawn(b, std::make_shared<Square>(5, 5), Color::White);
  auto bpiece_to_be_captured1 = new Rook(b, std::make_shared<Square>(6, 6), Color::Black);
  auto bpiece_to_be_captured2 = new Queen(b, std::make_shared<Square>(6, 4), Color::Black);
  auto bpiece_to_be_captured3 = new Bishop(b, std::make_shared<Square>(4, 6), Color::Black);
  auto bpiece_to_be_captured4 = new Knight(b, std::make_shared<Square>(4, 4), Color::Black);
  std::vector<Piece*> pieces;
  ...
  auto wp_cant_be_captured1 = new Pawn(b, std::make_shared<Square>(6,4), Color::White);
  auto wp_cant_be_captured2 = new Pawn(b, std::make_shared<Square>(6,6), Color::White);
  ...
  auto bpc1 = new Pawn(b, std::make_shared<Square>(5, 5), Color::Black);
  auto wpiece_to_be_captured1 = new Rook(b, std::make_shared<Square>(6, 6), Color::White);
  auto wpiece_to_be_captured2 = new Queen(b, std::make_shared<Square>(6, 4), Color::White);
  auto wpiece_to_be_captured3 = new Bishop(b, std::make_shared<Square>(4, 6), Color::White);
  auto wpiece_to_be_captured4 = new Knight(b, std::make_shared<Square>(4, 4), Color::White);
  pieces.clear();
  pieces.push_back(wpc1);
  ...
  auto bp_cant_be_captured1 = new Pawn(b, std::make_shared<Square>(4,4), Color::Black);
  auto bp_cant_be_captured2 = new Pawn(b, std::make_shared<Square>(4,6), Color::Black);
...
TEST(PawnTests, PawnMovementWillBeCheck) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto pmwbc1 = new Pawn(b, std::make_shared<Square>(2,5), Color::White);
  auto pmwbc2 = new Pawn(b, std::make_shared<Square>(2,6), Color::White);
  auto king = new King(b, std::make_shared<Square>(1,6), Color::White);
  auto bishop = new Bishop(b, std::make_shared<Square>(4,3), Color::Black);
  auto rook = new Rook(b, std::make_shared<Square>(7,6), Color::Black);
  auto pawn = new Pawn(b, std::make_shared<Square>(3,7), Color::Black);
  std::vector<Piece*> pieces;
...
TEST(PawnTests, PawnPromotion) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto wp1 = new Pawn(b, std::make_shared<Square>(7,1), Color::White);
  auto wp2 = new Pawn(b, std::make_shared<Square>(7,2), Color::White);
  auto wp3 = new Pawn(b, std::make_shared<Square>(7,3), Color::White);
  auto wp4 = new Pawn(b, std::make_shared<Square>(7,4), Color::White);
  auto bp1 = new Pawn(b, std::make_shared<Square>(2,5), Color::Black);
  auto bp2 = new Pawn(b, std::make_shared<Square>(2,6), Color::Black);
  auto bp3 = new Pawn(b, std::make_shared<Square>(2,7), Color::Black);
  auto bp4 = new Pawn(b, std::make_shared<Square>(2,8), Color::Black);
  std::vector<Piece*> pieces;
...
TEST(KnightTests, KnightInitialization) {
  auto white_knight = new Knight(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto black_knight = new Knight(nullptr, std::make_shared<Square>(5, 2), Color::Black);
...
TEST(KnightTests, KnightSetters) {
  auto wn_setter = new Knight(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto bn_setter = new Knight(nullptr, std::make_shared<Square>(2, 5), Color::Black);
...
TEST(KnightTests, KnightMovementOnEmptyBoard) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto wneb1 = new Knight(b, std::make_shared<Square>(5, 5), Color::White);
  std::vector<Piece*> pieces;
  ...
  pieces.clear();
  auto wneb2 = new Knight(b, std::make_shared<Square>(2, 3), Color::White);
  m->from = std::make_shared<Square>(2,3);
  ...
  pieces.clear();
  auto bneb1 = new Knight(b, std::make_shared<Square>(1, 4), Color::Black);
  ...
  pieces.clear();
  auto bneb2 = new Knight(b, std::make_shared<Square>(1, 1), Color::Black);
...
TEST(KnightTests, KnightMovementCapture) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto wknight = new Knight(b, std::make_shared<Square>(5,5), Color::White);
  auto rook = new Rook(b, std::make_shared<Square>(7,6), Color::Black);
  auto bishop = new Bishop(b, std::make_shared<Square>(3, 6), Color::White);
  auto bknight = new Knight(b, std::make_shared<Square>(5,7), Color::Black);
  std::vector<Piece*> pieces;
...
TEST(KnightTests, KnightMovementWillBeCheck) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto wknight = new Knight(b, std::make_shared<Square>(2,2), Color::White);
  auto wking = new King(b, std::make_shared<Square>(1,2), Color::White);
  auto bknight = new Knight(b, std::make_shared<Square>(7,2), Color::Black);
  auto bking = new King(b, std::make_shared<Square>(8,2), Color::Black);
  auto wrook = new Rook(b, std::make_shared<Square>(6,2), Color::White);
  auto brook = new Rook(b, std::make_shared<Square>(3,2), Color::Black);
  auto bbishop = new Bishop(b, std::make_shared<Square>(1,4), Color::Black);
  auto wbishop = new Bishop(b, std::make_shared<Square>(8,4), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(wknight);
...
TEST(BishopTests, BishopInitialization) {
  auto white_bishop = new Bishop(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto black_bishop = new Bishop(nullptr, std::make_shared<Square>(5, 2), Color::Black);
...
TEST(BishopTests, BishopSetters) {
  auto wb_setter = new Bishop(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto bb_setter = new Bishop(nullptr, std::make_shared<Square>(2, 5), Color::Black);
...
TEST(BishopTests, BishopMovementOnEmptyBoard) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto b1 = new Bishop(b, std::make_shared<Square>(5,5), Color::White);
  std::vector<Piece*> pieces;
  pieces.push_back(b1);
  auto m = std::make_shared<Move>();
  m->from = std::make_shared<Square>(5,5);
  ...
  pieces.clear();
  auto b2 = new Bishop(b, std::make_shared<Square>(5,4), Color::Black);
  pieces.push_back(b2);
...
TEST(BishopTests, BishopMovementPieceBlocking) {
  ...
  auto b = std::make_shared<Board>(td);
  auto b1 = new Bishop(b, std::make_shared<Square>(5,5), Color::White);
  auto pawn = new Pawn(b, std::make_shared<Square>(2,2), Color::White);
  auto rook = new Rook(b, std::make_shared<Square>(7,7), Color::Black);
  auto knight = new Knight(b, std::make_shared<Square>(7,3), Color::White);
  auto queen = new Queen(b, std::make_shared<Square>(3,7), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(b1);
  pieces.push_back(pawn);
  pieces.push_back(rook);
  ...
  pieces.clear();
  auto b2 = new Bishop(b, std::make_shared<Square>(5,4), Color::Black);
  auto pawn2 = new Pawn(b, std::make_shared<Square>(2,7), Color::White);
  auto rook2 = new Rook(b, std::make_shared<Square>(7,2), Color::Black);
  auto knight2 = new Knight(b, std::make_shared<Square>(7,6), Color::White);
  auto queen2 = new Queen(b, std::make_shared<Square>(3,2), Color::Black);
  pieces.push_back(b2);
...
TEST(BishopTests, BishopMovementWillBeCheck) {
  ...
  auto b = std::make_shared<Board>(td);
  auto b1 = new Bishop(b, std::make_shared<Square>(5,5), Color::White);
  auto b2 = new Bishop(b, std::make_shared<Square>(5,6), Color::White);
  auto king = new King(b, std::make_shared<Square>(6,6), Color::White);
  auto rook = new Rook(b, std::make_shared<Square>(1,6), Color::Black);
  auto queen = new Queen(b, std::make_shared<Square>(1,1), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(b1);
  pieces.push_back(b2);
  pieces.push_back(king);
...
TEST(RookTests, RookInitialization) {
  auto white_rook = new Rook(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto black_rook = new Rook(nullptr, std::make_shared<Square>(5, 2), Color::Black);
...
TEST(RookTests, RookSetters) {
  auto wr_setter = new Rook(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto br_setter = new Rook(nullptr, std::make_shared<Square>(2, 5), Color::Black);
...
TEST(RookTests, RookMovementOnEmptyBoard) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto rook = new Rook(b, std::make_shared<Square>(5,5), Color::White);
  std::vector<Piece*> pieces;
  pieces.push_back(rook);
  auto m = std::make_shared<Move>();
  m->from = std::make_shared<Square>(5,5);
...
TEST(RookTests, RookMovementPieceBlocking) {
  ...
  auto b = std::make_shared<Board>(td);
  auto rook = new Rook(b, std::make_shared<Square>(5,5), Color::White);
  auto queen = new Queen(b, std::make_shared<Square>(2,5), Color::White);
  auto knight = new Knight(b, std::make_shared<Square>(7,5), Color::Black);
  auto bishop = new Bishop(b, std::make_shared<Square>(5,2), Color::White);
  auto pawn = new Pawn(b, std::make_shared<Square>(5,7), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(rook);
  pieces.push_back(queen);
  pieces.push_back(knight);
...
TEST(RookTests, RookMovementWillBeCheck) {
  ...
  auto b = std::make_shared<Board>(td);
  auto rook = new Rook(b, std::make_shared<Square>(5,5), Color::White);
  auto king = new King(b, std::make_shared<Square>(6,5), Color::White);
  auto queen = new Queen(b, std::make_shared<Square>(2,5), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(rook);
  pieces.push_back(king);
  pieces.push_back(queen);
...
TEST(QueenTests, QueenInitialization) {
  auto white_queen = new Queen(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto black_queen = new Queen(nullptr, std::make_shared<Square>(5, 2), Color::Black);
...
TEST(QueenTests, QueenSetters) {
  auto wq_setter = new Queen(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto bq_setter = new Queen(nullptr, std::make_shared<Square>(2, 5), Color::Black);
...
TEST(QueenTests, QueenMovementOnEmptyBoard) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto queen = new Queen(b, std::make_shared<Square>(5,5), Color::White);
  std::vector<Piece*> pieces;
  pieces.push_back(queen);
  auto m = std::make_shared<Move>();
  m->from = std::make_shared<Square>(5,5);
  ...
  pieces.clear();
  auto queen2 = new Queen(b, std::make_shared<Square>(5,4), Color::Black);
  pieces.push_back(queen2);
  m->from = std::make_shared<Square>(5,4);
  m->to = std::make_shared<Square>(1,1);
...
TEST(QueenTests, QueenMovementPieceBlocking) {
  ...
  auto b = std::make_shared<Board>(td);
  auto queen = new Queen(b, std::make_shared<Square>(5,5), Color::White);
  auto rook = new Rook(b, std::make_shared<Square>(2,5), Color::White);
  auto knight = new Knight(b, std::make_shared<Square>(7,5), Color::Black);
  auto bishop = new Bishop(b, std::make_shared<Square>(5,2), Color::White);
  auto pawn = new Pawn(b, std::make_shared<Square>(5,7), Color::Black);
  auto pawn2 = new Pawn(b, std::make_shared<Square>(2,2), Color::White);
  auto rook2 = new Rook(b, std::make_shared<Square>(7,7), Color::Black);
  auto knight2 = new Knight(b, std::make_shared<Square>(7,3), Color::White);
  auto queen2 = new Queen(b, std::make_shared<Square>(3,7), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(queen);
  pieces.push_back(rook);
  pieces.push_back(knight);
...
TEST(QueenTests, QueenMovementWillBeCheck) {
  ...
  auto b = std::make_shared<Board>(td);
  auto queen = new Queen(b, std::make_shared<Square>(5,5), Color::White);
  auto rook = new Rook(b, std::make_shared<Square>(1,5), Color::Black);
  auto king = new King(b, std::make_shared<Square>(6,5), Color::White);
  std::vector<Piece*> pieces;
  pieces.push_back(queen);
  pieces.push_back(rook);
...
TEST(KingTests, KingInitialization) {
  auto white_king = new King(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto black_king = new King(nullptr, std::make_shared<Square>(5, 2), Color::Black);
...
TEST(KingTests, KingSetters) {
  auto wk_setter = new King(nullptr, std::make_shared<Square>(2, 5), Color::White);
  ...
  auto bk_setter = new King(nullptr, std::make_shared<Square>(2, 5), Color::Black);
...
TEST(KingTests, KingMovementOnEmptyBoard) {
  auto td = std::make_shared<TextDisplay>();
  auto b = std::make_shared<Board>(td);
  auto king = new King(b, std::make_shared<Square>(5,5), Color::White);
  std::vector<Piece*> pieces;
  pieces.push_back(king);
  auto m = std::make_shared<Move>();
  m->from = std::make_shared<Square>(5,5);
  ...
  pieces.clear();
  auto king2 = new King(b, std::make_shared<Square>(1,5), Color::Black);
  ...
  pieces.clear();
  auto king3 = new King(b, std::make_shared<Square>(1,1), Color::White);
...
TEST(KingTests, KingMovementCapture) {
  ...
  auto b = std::make_shared<Board>(td);
  auto king = new King(b, std::make_shared<Square>(5,5), Color::White);
  auto pawn = new Pawn(b, std::make_shared<Square>(4,4), Color::Black);
  auto bishop = new Bishop(b, std::make_shared<Square>(6,6), Color::Black);
  auto rook = new Rook(b, std::make_shared<Square>(4,6), Color::White);
  auto queen = new Queen(b, std::make_shared<Square>(6,4), Color::White);
  std::vector<Piece*> pieces;
  pieces.push_back(king);
  pieces.push_back(pawn);
  pieces.push_back(bishop);
...
TEST(KingTests, KingMovementWillBeCheck) {
  ...
  auto b = std::make_shared<Board>(td);
  auto king = new King(b, std::make_shared<Square>(5,5), Color::White);
  auto bishop = new Bishop(b, std::make_shared<Square>(5,4), Color::Black);
  auto rook = new Rook(b, std::make_shared<Square>(1,6), Color::Black);
  std::vector<Piece*> pieces;
  pieces.push_back(king);
  pieces.push_back(bishop);
...
TEST(KingTests, KingCastling) {
  ...
  std::vector<Piece*> pieces;
  {
    auto king = new King(b, std::make_shared<Square>(1,5), Color::White);
    auto rook1 = new Rook(b, std::make_shared<Square>(1,8), Color::White);
    pieces.push_back(king);
  ...
  {
    auto king = new King(b, std::make_shared<Square>(1,5), Color::White);
    auto rook1 = new Rook(b, std::make_shared<Square>(1,1), Color::White);
    pieces.push_back(king);
    pieces.push_back(rook1);
    auto m = std::make_shared<Move>();
    m->from = std::make_shared<Square>(1,5);
  ...
  {
    auto king = new King(b, std::make_shared<Square>(2,5), Color::White);
    auto rook1 = new Rook(b, std::make_shared<Square>(1,1), Color::White);
    pieces.push_back(king);
    pieces.push_back(rook1);
    auto m = std::make_shared<Move>();
  ...
  {
    auto king = new King(b, std::make_shared<Square>(1,5), Color::White);
    auto rook1 = new Rook(b, std::make_shared<Square>(2,1), Color::White);
    pieces.push_back(king);
    pieces.push_back(rook1);
    auto m = std::make_shared<Move>();
